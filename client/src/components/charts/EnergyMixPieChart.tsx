    ...
    <div className="w-full bg-slate-900/50 border border-slate-700 rounded-2xl p-6">
      {title && (
        <div className="text-center mb-4">
          ...
          <p className="text-slate-400 text-sm">Real-time energy generation mix</p>
        </div>
      )}
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 text-center">
        <div className="bg-slate-800/50 rounded-lg p-3">
          ...
          <p className="text-slate-400 text-sm">Clean Energy</p>
        </div>
        <div className="bg-slate-800/50 rounded-lg p-3">
          ...
          <p className="text-slate-400 text-sm">Fossil Fuels</p>
        </div>
      </div>
    </div>
  );
